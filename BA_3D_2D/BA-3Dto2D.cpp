        ...
        Mat& K   )
{
    ...
    // ----------------------开始你的代码：设置并添加边
    index = 1;
    for (const Point2f point_2d : points_2d) {
        g2o::EdgeProjectXYZ2UV* e = new g2o::EdgeProjectXYZ2UV();
        e->setId(index);
        e->setVertex(0, dynamic_cast<g2o::VertexSBAPointXYZ*> (optimizer.vertex(index)));
        e->setVertex(1, pose);
        e->setMeasurement(Eigen::Vector2d(point_2d.x, point_2d.y));
